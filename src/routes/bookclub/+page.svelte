		...
		<div class="md:flex">
			...
			<div class="min-w-0 flex-1 bg-[#008080] p-3 sm:p-5">
				...
				<div class="mt-2 grid gap-5 lg:grid-cols-2">
					{#each visiblePanelIds as panelId, position (panelId)}
						{#if panelId === 'current-book'}
							<DashboardPanel
								...
								collapsed={collapsedPanels['current-book'] === true}
								wide
						...
						{:else if panelId === 'suggestions'}
							<DashboardPanel
								...
								{position}
								total={visiblePanelIds.length}
								collapsed={collapsedPanels.suggestions === true}
						...
						{:else if panelId === 'chatroom'}
							<DashboardPanel
								...
								{position}
								total={visiblePanelIds.length}
								collapsed={collapsedPanels.chatroom === true}
						...
						{:else if panelId === 'archive'}
							<DashboardPanel
								...
								{position}
								total={visiblePanelIds.length}
								collapsed={collapsedPanels.archive === true}
						...
						{:else if panelId === 'admin' && data.member.role === 'admin'}
							<DashboardPanel
								...
								{position}
								total={visiblePanelIds.length}
								collapsed={collapsedPanels.admin === true}
											...
											>
												...
												<input
													...
													value={meetingInputValue(
														data.dashboard.nextMeeting?.scheduledFor ?? null
													)}
