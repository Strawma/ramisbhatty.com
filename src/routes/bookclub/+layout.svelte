...
<div class="bookclub-theme relative isolate min-h-screen overflow-hidden bg-[#008080]">
	<ClubhouseBackdrop />
...
<style>
	...
	/* These shared fills keep every book-club route within the same deliberately striped palette. */
